...
#define LevelOneSize (NumDirect * SectorSize)
#define LevelTwoSize (NumDirect * NumDirect * SectorSize)
//#define LevelThreeSize (NumDirect * NumDirect * NumDirect * SectorSize)
