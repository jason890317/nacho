...
// Note: this code assumes that virtual address = physical address
    ...
    Translate(noffH.initData.virtualAddr, &addr, false);// use Translate() to calculate phy_addr
...
#ifdef RDATA
    Translate(noffH.readonlyData.virtualAddr, &addr, false);// use Translate() to calculate phy_addr
